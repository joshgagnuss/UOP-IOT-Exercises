  ...
  if (var == "TEMPERATURE"){
   ...
   if(var == "BUTTONPLACEHOLDER"){
    ...
    for(int i=1; i<=NUM_RELAYS; i++){
      ...
      buttons+= "<h4>""Manual Override""</h4><label class=\"switch\"><input type=\"checkbox\" onchange=\"toggleCheckbox(this)\" id=\"" + String(i) + "\" "+ relayStateValue +"><span class=\"slider\"></span></label>";
    }
    return buttons;
  }
  return String();
